...
class Idc(db.Model):
    ...
    __tablename__ = 'idc'
    id = db.Column(db.Integer, primary_key=True)
    name = db.Column(db.String(10),nullable=False,unique=True,index=True)
...
class Power(db.Model):
    ...
    __tablename__ = 'power'
    id = db.Column(db.Integer, primary_key=True)
    server_power = db.Column(db.String(20),unique=True,default='')
...
class Ip_Info(db.Model):
    ...
    switch_port = db.Column(db.Integer,nullable=False)
...
class Server(db.Model):
    ...
    idc_id = db.Column(db.Integer, index=True,nullable=True,default=0)
    cabinet_id = db.Column(db.Integer,nullable=True,default=0)
    ...
    uuid = db.Column(db.String(100),index=True,nullable=False,unique=True)
    hostname = db.Column(db.String(32), index=True,default='')
    inner_ip = db.Column(db.String(32), index=True,nullable=True,default='')
...
class Switch(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    switch_name = db.Column(db.String(60),nullable=False)
    switch_type = db.Column(db.String(60),nullable=False)
    manager_ip = db.Column(db.String(60),nullable=False)
...
class Managementcardtype(db.Model):
    ...
    id = db.Column(db.Integer, primary_key=True)
    m_type = db.Column(db.String(60),nullable=False,unique=True)
